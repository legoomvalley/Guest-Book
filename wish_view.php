...
{  
	...
	$queryView = "select * from wish_book ORDER BY Wish_User ASC";
...
<br><br>
click <a href="wish_edit_view.php">here </a> to Update a Record
<br><br>
click <a href="wish_delete_view.php">here </a> to Delete a Record
<br><br>
