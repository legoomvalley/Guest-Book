...
<h1>E-Quest Book</h1>
<h2>CHOOSE Wish TO BE DELETED</h2>

<form action="wish_delete.php" name="DeleteForm" method="POST" onSubmit="return confirm('Are you sure to delete this record?')" >
...
?>
<br></br>
<input type="Submit" value="Delete chosen Wish">
</form>
<br><br>
